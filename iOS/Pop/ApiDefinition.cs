...
namespace Pop
{
    ...
    interface POPMutableAnimatableProperty {
        ...
        [Export ("readBlock", ArgumentSemantic.Copy)]
        Action<NSObject, nfloat> ReadBlock { get; set; }

        // @property (readwrite, copy, nonatomic) void (^)(id, const CGFloat *) writeBlock;
        [Export ("writeBlock", ArgumentSemantic.Copy)]
        Action<NSObject, nfloat> WriteBlock { get; set; }
    ...
    interface POPAnimation {
        ...
        [NullAllowed]
        POPAnimationDelegate WeakDelegate { get; set; }
    ...
    interface POPAnimator {
        ...
        [Export ("delegate", ArgumentSemantic.Weak)]
        [NullAllowed]
        POPAnimatorDelegate WeakDelegate { get; set; }
    ...
    interface POPCustomAnimation {
        ...
        POPCustomAnimation AnimationWithBlock (Func<NSObject, POPCustomAnimation, bool> block);
    }
